<template>
    <div class="course-main">
        ...
        <section class="course-section content-part common-style">
            <div class="center-wrap">
...
.common-style ul>li:nth-child(4n) {
    margin-right: 0;
}
...
.common-style ul>li.pro-grid .picbox {
    position: relative;
    transform: scale();
    height: 184px;
}
.common-style ul>li.pro-grid .picbox img {
    width: 264px;
    height: 184px;
}
.common-style ul>li.pro-grid .wordbox {
    padding: 14px;
    font-size: 15px;
    color: #1C1F21;
    line-height: 26px;
...
.common-style ul li .wordbox .proname {
    font-weight: bold;
    font-size: 16px;
    color: #000000;
    height: 30px;
