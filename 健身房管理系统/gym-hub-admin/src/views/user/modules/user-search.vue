...
<template>
  <NCard :bordered="false" size="small" class="card-wrapper">
    ...
    <NFormItemGi span="24 s:12 m:6" label="手机号：" path="qp_phone_like" class="pr-24px">
      <NInput v-model:value="model.qp_phone_like" placeholder="请输入" />
    </NFormItemGi>
    <NFormItemGi span="24 s:12 m:6" label="性别：" path="qp_sex_eq" class="pr-24px">
      <NSelect
        v-model:value="model.qp_sex_eq"
        :options="sexOptions"
        placeholder="请选择"
      />
    </NFormItemGi>
    <NFormItemGi span="24 s:12 m:6" label="状态：" path="qp_enable_eq" class="pr-24px">
      <!-- <NInput v-model:value="model.qp_enable_like" placeholder="请输入" /> -->
      <NSelect
        v-model:value="model.qp_enable_eq"
