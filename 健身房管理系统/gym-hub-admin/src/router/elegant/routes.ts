...
export const generatedRoutes: GeneratedRoute[] = [
  ...
  },
  {
    name: 'carousel',
    path: '/carousel',
    component: 'layout.base$view.carousel',
    meta: {
      title: 'carousel',
      i18nKey: 'route.carousel'
    }
  },
  {
    name: 'category',
  ...
  },
  {
    name: 'classification',
    path: '/classification',
    component: 'layout.base$view.classification',
    meta: {
      title: 'classification',
      i18nKey: 'route.classification'
    }
  },
  {
    name: 'coach',
    path: '/coach',
    component: 'layout.base$view.coach',
    meta: {
      title: 'coach',
      i18nKey: 'route.coach'
    }
  ...
  },
  {
    name: 'courseappraise',
    path: '/courseappraise',
    component: 'layout.base$view.courseappraise',
    meta: {
      title: 'courseappraise',
      i18nKey: 'route.courseappraise'
    }
  },
  {
    name: 'coursereserve',
    path: '/coursereserve',
    component: 'layout.base$view.coursereserve',
    meta: {
      title: 'coursereserve',
      i18nKey: 'route.coursereserve'
    }
  },
  {
    name: 'forum',
    ...
    children: [
      {
        name: 'forum_post',
        path: '/forum/post',
        component: 'view.forum_post',
        meta: {
          title: 'forum_post',
          i18nKey: 'route.forum_post'
        }
      },
      {
        name: 'forum_postcomment',
        path: '/forum/postcomment',
        component: 'view.forum_postcomment',
        meta: {
          title: 'forum_postcomment',
          i18nKey: 'route.forum_postcomment'
        }
      }
    ]
  },
  ...
  },
  {
    name: 'orderdetail',
    path: '/orderdetail',
    component: 'layout.base$view.orderdetail',
    meta: {
      title: 'orderdetail',
      i18nKey: 'route.orderdetail'
    }
  },
  {
    name: 'plugin',
  ...
  },
  {
    name: 'rechargerecord',
    path: '/rechargerecord',
    component: 'layout.base$view.rechargerecord',
    meta: {
      title: 'rechargerecord',
      i18nKey: 'route.rechargerecord'
    }
  },
  {
    name: 'sku',
    path: '/sku',
    component: 'layout.base$view.sku',
    meta: {
      title: 'sku',
      i18nKey: 'route.sku'
    }
  },
  {
    name: 'skuappraise',
    path: '/skuappraise',
    component: 'layout.base$view.skuappraise',
    meta: {
      title: 'skuappraise',
      i18nKey: 'route.skuappraise'
    }
  },
  {
    name: 'user',
