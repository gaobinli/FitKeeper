...
public class CarouselController {
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "currentPage", value = "当前页数", paramType = "query", dataTypeClass = Map.class),
            ...
            @ApiImplicitParam(name = "qp-name-eq", value = "轮播图名称", paramType = "query", dataTypeClass = Map.class),
            @ApiImplicitParam(name = "qp-url-eq", value = "图片", paramType = "query", dataTypeClass = Map.class),
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    @ApiImplicitParams({
            @ApiImplicitParam(name = "name", value = "轮播图名称", paramType = "query", dataTypeClass = Map.class),
            @ApiImplicitParam(name = "url", value = "图片", paramType = "query", dataTypeClass = Map.class),
