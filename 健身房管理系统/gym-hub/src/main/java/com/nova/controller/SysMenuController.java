...
public class SysMenuController {
    ...
    @GetMapping(value = "/route/getConstantRoutes", produces = {"application/json"})
    public ResultDTO<List<SysMenuResDto>> getConstantRoutes() {
        List<SysMenuResDto> menuTree = sysMenuService.getConstantRoutes();
        return ResultDTO.ok(menuTree);
    }
