...
public class SkuAppraiseController {
     ...
     * @return 返回新创建的资源对象
     */
    @ApiOperation(value = "查询所有数据", tags = {"skuAppraise"}, nickname = "getList")
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    @GetMapping(value = "/list", produces = {"application/json"})
    public ResultDTO<List<SkuAppraiseResDto>> getList() {
        List<SkuAppraiseResDto> resDtos = skuAppraiseService.getList();
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "currentPage", value = "当前页数", paramType = "query", dataTypeClass = Map.class),
            ...
            @ApiImplicitParam(name = "qp-skuId-eq", value = "课程", paramType = "query", dataTypeClass = Map.class),
            ...
            @ApiImplicitParam(name = "qp-experienceAppraise-eq", value = "学习体验评分", paramType = "query", dataTypeClass = Map.class),
            @ApiImplicitParam(name = "qp-skuAppraise-eq", value = "课程评分", paramType = "query", dataTypeClass = Map.class),
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    @ApiImplicitParams({
            @ApiImplicitParam(name = "skuId", value = "课程", paramType = "query", dataTypeClass = Map.class),
            ...
            @ApiImplicitParam(name = "experienceAppraise", value = "学习体验评分", paramType = "query", dataTypeClass = Map.class),
            @ApiImplicitParam(name = "skuAppraise", value = "课程评分", paramType = "query", dataTypeClass = Map.class),
