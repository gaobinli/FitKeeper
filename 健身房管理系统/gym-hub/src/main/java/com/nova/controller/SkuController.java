...
public class SkuController {
     ...
     * @return 返回新创建的资源对象
     */
    @ApiOperation(value = "查询所有数据", tags = {"sku"}, nickname = "getList")
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    @GetMapping(value = "/list", produces = {"application/json"})
    public ResultDTO<List<SkuResDto>> getList() {
        List<SkuResDto> resDtos = skuService.getList();
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "currentPage", value = "当前页数", paramType = "query", dataTypeClass = Map.class),
            ...
            @ApiImplicitParam(name = "qp-categoryId-eq", value = "分类", paramType = "query", dataTypeClass = Map.class),
            ...
            @ApiImplicitParam(name = "qp-simpleDesc-eq", value = "简单描述", paramType = "query", dataTypeClass = Map.class),
            ...
            @ApiImplicitParam(name = "qp-detail-eq", value = "课程介绍", paramType = "query", dataTypeClass = Map.class),
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "categoryId", value = "分类", paramType = "query", dataTypeClass = Map.class),
            ...
            @ApiImplicitParam(name = "simpleDesc", value = "简单描述", paramType = "query", dataTypeClass = Map.class),
            ...
            @ApiImplicitParam(name = "detail", value = "课程介绍", paramType = "query", dataTypeClass = Map.class),
