...
import com.nova.domain.dto.res.AnnouncementResDto;
import com.nova.service.AnnouncementService;
...
public class AnnouncementController {
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "currentPage", value = "当前页数", paramType = "query", dataTypeClass = Map.class),
            ...
            @ApiImplicitParam(name = "qp-type-eq", value = "类型：1 系统资讯、2 系统公告", paramType = "query", dataTypeClass = Map.class),
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "type", value = "类型：1 系统资讯、2 系统公告", paramType = "query", dataTypeClass = Map.class),
